...
module khoree_pre_id(
    ...
    assign inst_jal_o = (opcode == `KHOREE_INST_JAL) ? 1'b1 : 1'b0;
    assign inst_jalr_o = (opcode == `KHOREE_INST_JALR) ? 1'b1 : 1'b0;
    assign inst_bxx_o = (opcode == `KHOREE_INST_TYPE_B) ? 1'b1 : 1'b0;
